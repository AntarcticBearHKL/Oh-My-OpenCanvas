...
const demoUrl = 'https://github.com/AntarcticBearHKL/Oh-My-OpenCanvas';
...
const messages = {
  en: {
    ...
    description: 'OpenCanvas brings canvas composition, AI generation, reference editing, prompt libraries, and reusable assets into one workflow.',
    quickStart: 'Quick Start',
    demo: 'Live Demo',
    gallery: 'Gallery',
    features: 'Explore Features',
    previewAlt: 'OpenCanvas preview',
  ...
  'zh-CN': {
    ...
    center: '文档中心',
    description: 'OpenCanvas 是一款面向图片创作的画布工具，把画布编排、AI 生成、参考图编辑、提示词库和素材沉淀放在同一个工作流里。',
    quickStart: '快速开始',
    demo: '在线体验',
    gallery: '效果展示',
    features: '功能介绍',
    previewAlt: 'OpenCanvas 效果图',
    contributors: '开发贡献者',
