...
const tabs: DocsSection[] = [
  ...
  { title: { en: 'Development', 'zh-CN': '开发文档' }, description: { en: 'Local development and internals', 'zh-CN': '本地开发与内部结构' }, href: '/docs/development/local-development', prefix: '/docs/development', pages: ['local-development', 'local-canvas-mcp', 'canvas-data-structure'], icon: Code2 },
