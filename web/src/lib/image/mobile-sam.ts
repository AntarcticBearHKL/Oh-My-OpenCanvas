...
export const MOBILE_SAM_ENCODER_URL = "https://huggingface.co/PulpCut/mobilesam-onnx/resolve/main/mobilesam.encoder.onnx";
export const MOBILE_SAM_DECODER_URL = "https://huggingface.co/PulpCut/mobilesam-onnx/resolve/main/mobilesam.decoder.onnx";
export const MOBILE_SAM_CACHE_NAME = "mobilesam-onnx-v1";
