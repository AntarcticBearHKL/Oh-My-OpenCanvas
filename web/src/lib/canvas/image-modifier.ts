...
export type ImageModifierParamUnit = "%" | "deg" | "px" | "EV" | "";
...
export type ImageModifierToneParamSpec = Omit<ImageModifierParamSpec, "cssFn">;
...
export const IMAGE_MODIFIER_ALL_PARAMS: ImageModifierToneParamSpec[] = [...IMAGE_MODIFIER_TONE_PARAMS, ...IMAGE_MODIFIER_PARAMS];
...
export function applyImageModifierLut(imageData: ImageData, params?: Partial<CanvasImageModifierParams> | null, curve?: CanvasImageModifierCurvePoint[] | null): void {
