...
import { App, Button, Dropdown, Empty, Input, Popconfirm, Spin, Tag } from "antd";
import { useQuery } from "@tanstack/react-query";
import { BookOpen, Check, ChevronRight, Eye, FileText, FolderInput, FolderPlus, PanelLeftClose, Pencil, Plus, Search, Trash2, X } from "lucide-react";
...
export function CanvasSidePanel({ onInsertAsset }: Props) {
    ...
    return (
        ...
        >
            <motion.aside
                className="relative flex h-full shrink-0 flex-col overflow-hidden border-r max-md:max-w-[85vw]"
                initial={{ x: -48 }}
            ...
            >
                ...
                <div className="mt-2 min-h-0 flex-1 overflow-hidden">
                    {tab === "assets" ? <CanvasAssetsTab onInsert={onInsertAsset} theme={theme} /> : <CanvasPromptsTab onInsert={onInsertAsset} theme={theme} />}
                </div>
