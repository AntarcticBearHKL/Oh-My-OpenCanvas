        ...
        >
            ...
            >
                <div className="flex items-center px-3 pt-3.5 md:hidden">
                    <button type="button" onClick={closePanel} className="ml-auto grid size-7 place-items-center rounded-md opacity-55 transition hover:bg-black/5 hover:opacity-100 dark:hover:bg-card/10" aria-label={t("canvas.collapsePanel")}>
