import { ImageIcon, List, Music2, Radio, Settings2, Video } from "lucide-react";
...
export function ConnectionCreateMenu({
    ...
    onCreate: (type: CanvasNodeType.Image | CanvasNodeType.Text | CanvasNodeType.Config | CanvasNodeType.Video | CanvasNodeType.Audio | CanvasNodeType.Output) => void;
    onClose: () => void;
}) {
    ...
    return (
        ...
        >
            ...
            <div className="grid gap-1">
                ...
                <ConnectionCreateOption theme={theme} icon={<Radio className="size-5" />} title={t("canvas.nodeTypes.output")} onClick={() => onCreate(CanvasNodeType.Output)} />
            </div>
        </div>
    );
}
