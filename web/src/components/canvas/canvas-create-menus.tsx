import { AudioLines, ImageIcon, List, Mic, Music2, Settings2, Sparkles, Video } from "lucide-react";
...
export function ConnectionCreateMenu({
    ...
    onCreate: (type: CanvasNodeType.Image | CanvasNodeType.Text | CanvasNodeType.Config | CanvasNodeType.Video | CanvasNodeType.Audio | CanvasNodeType.AudioGeneration | CanvasNodeType.SpeechGeneration | CanvasNodeType.MusicGeneration) => void;
    onClose: () => void;
}) {
