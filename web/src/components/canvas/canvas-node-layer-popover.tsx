    ...
    return (
        <div className={`rounded-2xl border p-2.5 text-sm ${frostedSurfaceClass}`} style={{ background: theme.toolbar.panel, borderColor: theme.toolbar.border, color: theme.node.text }}>
            ...
            <div className="thin-scrollbar mt-1.5 overflow-y-auto" style={{ maxHeight: maxListHeight }}>
                {listed.length ? (
                    listed.map((item) => (
                        <div key={item.id} className="flex items-center gap-1.5 rounded-lg px-1 py-1 transition hover:bg-black/5 dark:hover:bg-card/10">
                            <input
                                type="checkbox"
                            ...
                            <button
                                type="button"
                                className="grid size-6 shrink-0 place-items-center rounded-md opacity-60 transition hover:bg-black/5 hover:opacity-100 dark:hover:bg-card/10"
            ...
            <div className="mt-1.5 flex items-center gap-1.5 border-t pt-2" style={{ borderColor: theme.toolbar.border }}>
                ...
                <button
                    type="button"
                    className="h-7 shrink-0 rounded-lg px-2 text-xs font-medium transition hover:bg-black/5 disabled:opacity-30 disabled:hover:bg-transparent dark:hover:bg-card/10 dark:disabled:hover:bg-transparent"
