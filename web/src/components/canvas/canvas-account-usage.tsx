...
export function CanvasAccountUsage() {
    ...
    const content = (
        <div className="w-60 text-xs" style={{ color: theme.node.text }}>
            ...
            <button
                ...
                className="mt-2 flex w-full items-center justify-center gap-1 rounded-lg py-1 text-xs transition hover:bg-black/5 disabled:opacity-40 disabled:hover:bg-transparent dark:hover:bg-card/10 dark:disabled:hover:bg-transparent"
    ...
    return (
        ...
        >
            <button
                type="button"
                className="inline-flex size-7 shrink-0 cursor-pointer items-center justify-center rounded-md text-muted-foreground transition-colors hover:bg-black/5 hover:text-foreground dark:text-muted-foreground dark:hover:bg-card/10 dark:hover:text-white [&_svg]:size-4"
                style={{ color: theme.node.text }}
