                    ...
                    <div ref={titleRef} className="flex min-w-0 items-center gap-2 px-1">
                        {isTitleEditing ? (
                            <input
                                ...
                                className="max-w-[110px] bg-transparent p-0 text-left text-lg font-semibold tracking-normal outline-none sm:max-w-[160px] lg:max-w-[280px]"
                                style={{ color: theme.node.text }}
                            />
                        ) : (
                            <button
                                type="button"
                                className="max-w-[110px] truncate border-b border-dashed border-transparent text-left text-lg font-semibold tracking-normal transition hover:border-current sm:max-w-[160px] lg:max-w-[280px]"
