export default {
    ...
    canvas: {
        ...
        configNode: { title: "生成配置", image: "生图", text: "文本", video: "视频", audio: "音频", prompt: "提示词", references: "参考图", videoReferences: "参考视频", audioReferences: "参考音频", items: "{{count}} 个", images: "{{count}} 张", compose: "组装提示词", stop: "停止", generate: "开始生成", replaySeed: "同种子重播", promptSlot: "把提示词节点拖到这里绑定", promptBound: "已绑定提示词", noInputs: "连线输入提示词与参考图" },
        projectPage: {
