export default {
    ...
    canvas: {
        ...
        createMenu: {
            fromNode: "引用该节点生成", close: "关闭", text: "文本生成", textDescription: "脚本、广告词、品牌文案", image: "图片生成", video: "视频生成", audio: "音频参考", audioGeneration: "音频生成", speechGeneration: "语音生成", musicGeneration: "音乐生成", config: "配置节点", configDescription: "模型、尺寸、数量和输入顺序",
        },
        node: {
            node: "节点",
