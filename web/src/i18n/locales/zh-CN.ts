export default {
    ...
    canvas: {
        ...
        assets: { bind: "绑定文件夹", rebind: "更换文件夹", refresh: "刷新", unbound: "绑定一个本地文件夹，把里面的图片、视频、音频或文本拖到画布上。", count: "{{count}} 个文件", capped: "只显示前 {{count}} 个文件", empty: "文件夹里没有可用的文件", scanFailed: "读取文件夹失败，请重试", dropHint: "拖拽缩略图到画布", outputBind: "绑定输出文件夹", outputRebind: "更换输出文件夹", outputUnbind: "解除输出文件夹绑定", outputUnbound: "未绑定输出文件夹", outputUnsupported: "浏览器不支持", outputWriting: "写入中…", outputFailed: "写入失败" },
