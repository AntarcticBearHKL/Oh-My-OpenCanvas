export default {
    ...
    canvas: {
        ...
        toolbar: {
            ...
            light: "白", dark: "黑", dots: "点", lines: "线", blank: "空白", imageInfo: "图片信息",
        },
        project: {
