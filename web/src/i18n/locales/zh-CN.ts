export default {
    ...
    canvas: {
        ...
        toolbar: {
            select: "选择", pan: "移动", text: "文本", image: "图片", video: "视频", audio: "音频", config: "生成配置", extensions: "扩展节点", upload: "上传资产", zoom: "缩放",
        ...
        promptNode: { pick: "从预设库选择", pickerTitle: "从预设库选择提示词", search: "搜索提示词", placeholder: "输入或从预设库选择提示词", empty: "暂无提示词", panelHint: "在下方提示词面板中选择或编辑" },
        ...
        configNode: { title: "生成配置", image: "生图", text: "文本", video: "视频", audio: "音频", prompt: "提示词", references: "参考图", videoReferences: "参考视频", audioReferences: "参考音频", items: "{{count}} 个", images: "{{count}} 张", compose: "组装提示词", stop: "停止", generate: "开始生成", replaySeed: "同种子重播", matrix: "参数矩阵", matrixTitle: "参数矩阵", matrixDescription: "一次生成一组变体：尺寸、数量和提示词按组合整批入队。", matrixSizes: "尺寸", matrixCounts: "数量", matrixPrompts: "提示词", matrixHint: "用逗号或换行分隔多个值；留空表示该维度不参与组合。", matrixVariants: "将生成 {{count}} 个变体", generateVariants: "生成 {{count}} 个变体", matrixClear: "清空", matrixSave: "保存", promptSlot: "把提示词节点拖到这里绑定", promptBound: "已绑定提示词", noInputs: "连线输入提示词与参考图" },
        projectPage: {
