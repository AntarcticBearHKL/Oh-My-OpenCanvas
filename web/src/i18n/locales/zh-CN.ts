export default {
    ...
    canvas: {
        ...
        miniMapClose: "关闭小地图",
        resetView: "重置视图",
        nodeTypes: { image: "图片", text: "文本", prompt: "提示词", audioPrompt: "音频提示词", config: "生成配置", imageGeneration: "图片生成", speechGeneration: "语音生成", musicGeneration: "音乐生成", video: "视频", audio: "音频", smartCanvas: "智能画布", assets: "资源" },
        ...
        toolbar: {
            select: "选择", pan: "移动", text: "文本", video: "视频", config: "生成配置", extensions: "扩展节点", upload: "上传资产", zoom: "缩放",
