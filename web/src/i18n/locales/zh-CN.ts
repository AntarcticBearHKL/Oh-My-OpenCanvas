export default {
    ...
    canvas: {
        ...
        zoom: "放大/缩小画布",
        connecting: "连接中",
        nodeTypes: { image: "图片", text: "文本", config: "生成配置", video: "视频", audio: "音频", group: "组", smartCanvas: "智能画布" },
        toolbar: {
        ...
        smartCanvas: { preview: "预览合成", previewTitle: "智能画布合成预览", download: "下载合成图", ratio: "画板比例", resolution: "合成分辨率", placedCount: "{{count}} 张图片", empty: "把图片节点拖到画板上即可排版", noContent: "画板上没有可合成的图片", composeFailed: "合成失败，请重试" },
