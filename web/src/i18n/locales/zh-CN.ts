export default {
    ...
    canvas: {
        ...
        miniMapClose: "关闭小地图",
        resetView: "重置视图",
        nodeTypes: { image: "图片", text: "文本", prompt: "提示词", musicPrompt: "音乐提示词", speechPrompt: "语音提示词", videoPrompt: "视频提示词", config: "生成配置", imageGeneration: "图片生成", speechGeneration: "语音生成", musicGeneration: "音乐生成", videoGeneration: "视频生成", video: "视频", audio: "音频", smartCanvas: "智能画布", assets: "资源", recording: "录音", imageModifier: "图片修改器" },
        ...
        videoPrompt: { modeFrames: "首尾帧", modeReference: "参考图", firstFrame: "首帧", lastFrame: "尾帧", reference: "参考图", slots: "画面槽位", emptySlot: "拖入图片节点", clearSlot: "移除" },
        ...
        assets: { bind: "绑定文件夹", rebind: "更换文件夹", refresh: "刷新", unbound: "绑定一个本地文件夹，把里面的图片、视频、音频或文本拖到画布上。", count: "{{count}} 个文件", capped: "只显示前 {{count}} 个文件", empty: "文件夹里没有可用的文件", scanFailed: "读取文件夹失败，请重试", dropHint: "拖拽文件到画布", collectSaving: "保存到文件夹…", collectSaved: "已保存到文件夹", collectFailed: "保存失败", sourceFolder: "本地文件夹", sourceCache: "插件缓存", cacheConnecting: "正在连接插件…", cacheUnavailable: "未检测到插件", cacheInstallHint: "安装 OpenCanvas 浏览器插件后，可在这里查看并插入插件缓存的图片。", cacheCount: "{{count}} 张缓存", cacheEmpty: "插件缓存里没有可用的图片" },
