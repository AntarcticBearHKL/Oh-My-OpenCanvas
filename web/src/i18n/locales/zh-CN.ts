export default {
    ...
    canvas: {
        ...
        zoom: "放大/缩小画布",
        connecting: "连接中",
        nodeTypes: { image: "图片", text: "文本", config: "生成配置", imageGeneration: "图片生成", video: "视频", audio: "音频", group: "组", smartCanvas: "智能画布" },
        relations: { reference: "参考图", "video-reference": "参考视频", "audio-reference": "参考音频", prompt: "提示词", composite: "合成图", generation: "生成结果", crop: "裁剪结果", split: "切图结果", upscale: "放大结果", mask: "局部编辑结果", "background-removal": "抠图结果", frame: "视频截帧", group: "组内容", linked: "关联" },
        toolbar: {
            select: "选择", pan: "移动", text: "文本", image: "图片", video: "视频", audio: "音频", config: "生成配置", group: "组", extensions: "扩展节点", upload: "上传资产", zoom: "缩放", clear: "清空画布",
        ...
        export: { defaultProjectName: "无限画布" },
        createMenu: {
        ...
        sidePanel: {
            assets: "资产", prompts: "提示词库", resize: "调整左侧面板宽度", exportFailed: "导出失败，请重试",
        ...
        imageTools: { locked: "锁比例", free: "自由比例", lockTitle: "切换为等比缩放", freeTitle: "切换为自由比例", mask: "局部编辑", maskTitle: "添加蒙版遮罩后局部修改", crop: "裁剪", cropTitle: "裁剪并生成新节点", split: "切图", splitTitle: "按行列切分图片", upscale: "放大", upscaleTitle: "放大图片分辨率", superResolve: "超分", superResolveTitle: "AI 超分", angle: "多角度", angleTitle: "生成角度", view: "查看大图", viewTitle: "查看图片详情", more: "更多", configure: "配置快捷工具", customize: "自定义工具栏", showLabels: "显示按钮文字", description: "选择你想在图片节点编辑栏中使用的快捷工具。", preview: "节点预览", imageNode: "图片节点", quickTools: "快捷工具", removeBackground: "抠图", removeBackgroundTitle: "移除图片背景并生成透明底图片", removeBackgroundRunning: "正在抠图…（首次需下载模型，约 40MB）", removeBackgroundProgress: "正在抠图 {{percent}}%", removeBackgroundDownloading: "正在下载抠图模型 {{percent}}%", removeBackgroundDone: "已生成抠图结果", removeBackgroundFailed: "抠图失败", removeBackgroundResult: "抠图结果" },
    ...
    config: {
        ...
        webdav: {
            title: "WebDAV 同步",
            description: "同步画布、我的资产、生成记录和本地媒体文件，不包含 AI API Key，由浏览器直连 WebDAV。",
    ...
    agent: {
        ...
        state: { ready: "就绪", offline: "离线", skillReadFailed: "读取 Skill 失败", skillParseFailed: "Skill 解析失败", requestFailed: "本地 Agent 请求失败" },
