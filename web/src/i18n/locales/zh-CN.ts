export default {
    ...
    canvas: {
        ...
        project: {
            ...
            deleteTitle: "删除画布？", deleteDescription: "将删除 {{count}} 个画布，里面的节点和连线也会一起移除。", confirmDelete: "确认删除？",
        },
        ...
        switcher: { placeholder: "切换画布", nodes: "{{count}} 个节点", search: "搜索画布", new: "新建", load: "载入", empty: "此分组下没有画布", group: "分组：{{name}}" }, align: { title: "对齐", left: "左对齐", centerX: "水平居中", right: "右对齐", top: "顶对齐", centerY: "垂直居中", bottom: "底对齐", distributeX: "水平等距", distributeY: "垂直等距" }, layout: { title: "布局" }, sidePanel: {
        ...
        imageModifier: { brightness: "亮度", contrast: "对比度", saturation: "饱和度", hueRotate: "色相旋转", blur: "模糊", grayscale: "灰度", sepia: "复古", invert: "反色", opacity: "不透明度", blackPoint: "黑场", whitePoint: "白场", gamma: "伽马", exposure: "曝光", highlights: "高光", shadows: "阴影", curve: "色调曲线", curveReset: "重置曲线", generate: "生成修改图", baking: "生成中…", reset: "重置", resultTitle: "修改结果", baked: "已生成修改图", noSource: "先拖入一张图片节点", bakeFailed: "生成失败，请重试", sourceLoadFailed: "图片加载失败", rendering: "正在加载图片…", empty: "把图片节点拖进来应用滤镜", clear: "移除图片", dropHint: "拖入图片节点即可预览滤镜", emitOn: "拍摄：开", emitOff: "拍摄：关", emitTitle: "开启后拖入图片会直接生成新节点", emitHint: "拍摄已开启：拖入图片会立刻生成修改图并让原图归位" },
