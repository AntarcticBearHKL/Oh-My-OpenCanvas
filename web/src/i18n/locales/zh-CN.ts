export default {
    ...
    canvas: {
        ...
        miniMapClose: "关闭小地图",
        resetView: "重置视图",
        nodeTypes: { image: "图片", text: "文本", prompt: "提示词", config: "生成配置", imageGeneration: "图片生成", audioGeneration: "音频生成", musicGeneration: "音乐生成", video: "视频", audio: "音频", smartCanvas: "智能画布", assets: "资源" },
        ...
        createMenu: {
            fromNode: "引用该节点生成", close: "关闭", text: "文本生成", textDescription: "脚本、广告词、品牌文案", image: "图片生成", video: "视频生成", audio: "音频参考", audioGeneration: "音频生成", musicGeneration: "音乐生成", config: "配置节点", configDescription: "模型、尺寸、数量和输入顺序",
        },
        node: {
            node: "节点",
        ...
        promptPanel: { video: "描述要生成的视频内容", audio: "描述要生成的音频内容", music: "描述你想要生成的音乐（风格、乐器、情绪、场景等）", image: "描述要生成的图片内容", text: "请输入你想要生成的文本内容", editImage: "请输入你想要把这张图修改成什么", editText: "请输入你想要将本段文本修改成什么", expandEditor: "放大编辑", editorTitle: "编辑提示词", stopGeneration: "停止生成", generate: "生成", stop: "停止" },
