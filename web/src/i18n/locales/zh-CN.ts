export default {
    ...
    canvas: {
        ...
        miniMapClose: "关闭小地图",
        resetView: "重置视图",
        nodeTypes: { image: "图片", text: "文本", prompt: "提示词", config: "生成配置", imageGeneration: "图片生成", video: "视频", audio: "音频", group: "组", frame: "框架", smartCanvas: "智能画布", output: "输出" },
