export default {
    ...
    canvas: {
        ...
        nodeTypes: { image: "Image", text: "Text", config: "Generation config", imageGeneration: "Image generation", video: "Video", audio: "Audio", group: "Group", smartCanvas: "Smart Canvas" },
        relations: { reference: "Reference image", "video-reference": "Reference video", "audio-reference": "Reference audio", prompt: "Prompt", composite: "Composite", generation: "Generation result", crop: "Cropped", split: "Split", upscale: "Upscaled", mask: "Mask edited", "background-removal": "Background removed", frame: "Video frame", group: "Group content", linked: "Linked" },
        toolbar: {
            select: "Select", pan: "Move", text: "Text", image: "Image", video: "Video", audio: "Audio", config: "Generation config", group: "Group", extensions: "Extension nodes", upload: "Upload assets", zoom: "Zoom", clear: "Clear canvas",
        ...
        export: { defaultProjectName: "Infinite Canvas" },
        createMenu: {
        ...
        sidePanel: {
            assets: "Assets", prompts: "Prompt Library", resize: "Resize left panel", exportFailed: "Export failed. Try again.",
    ...
    config: {
        ...
        channels: {
            empty: "No providers yet. Add one to start configuring models.",
            add: "Add provider",
        ...
        webdav: {
            title: "WebDAV sync",
            description: "Sync canvases, assets, generation history, and local media files. AI API keys are excluded. The browser connects to WebDAV directly.",
    ...
    agent: {
        ...
        state: { ready: "Ready", offline: "Offline", skillReadFailed: "Failed to read Skill", skillParseFailed: "Failed to parse Skill", requestFailed: "Local Agent request failed" },
