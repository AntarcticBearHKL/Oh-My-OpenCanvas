export default {
    ...
    canvas: {
        ...
        toolbar: {
            ...
            light: "White", dark: "Black", dots: "Dots", lines: "Lines", blank: "Blank", imageInfo: "Image info",
        },
        project: {
