export default {
    ...
    canvas: {
        ...
        nodeTypes: { image: "Image", text: "Text", config: "Generation config", video: "Video", audio: "Audio", group: "Group", smartCanvas: "Smart Canvas" },
        toolbar: {
        ...
        smartCanvas: { preview: "Preview composite", previewTitle: "Smart Canvas preview", download: "Download composite", ratio: "Board ratio", resolution: "Composite resolution", placedCount: "{{count}} images", empty: "Drag image nodes onto the board to place them", noContent: "No images on the board to compose", composeFailed: "Failed to compose the board" },
