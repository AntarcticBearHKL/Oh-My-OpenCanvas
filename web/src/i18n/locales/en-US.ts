export default {
    ...
    canvas: {
        ...
        promptNode: { pick: "Pick from library", pickerTitle: "Pick a prompt", search: "Search prompts", placeholder: "Double-click to edit the prompt", empty: "No prompts" },
