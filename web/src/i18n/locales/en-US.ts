export default {
    ...
    canvas: {
        ...
        assetInput: { bind: "Bind folder", rebind: "Change folder", refresh: "Refresh", unbound: "Bind a local folder, then drag its images, videos, audio, or text onto the canvas.", count: "{{count}} files", capped: "Showing the first {{count}} files", empty: "No usable files in this folder", scanFailed: "Failed to read the folder. Try again.", dropHint: "Drag a thumbnail onto the canvas" },
