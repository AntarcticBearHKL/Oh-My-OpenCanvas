export default {
    ...
    settingsPanels: {
        ...
        video: { title: "Video settings", quality: "Quality", size: "Size", seconds: "Seconds", mode: "Mode", modes: { frames: "First & last frame", reference: "General reference" }, ratio: "Aspect ratio", smart: "Smart", adaptive: "Adaptive", },
    ...
    modelPlugin: {
        ...
        templates: { openai: "OpenAI format" },
        authoring: {
            intro: "Write a model request script for OpenCanvas. Capability: {{capability}}. Target model: {{model}}.",
    ...
    canvas: {
        ...
        nodeTypes: { image: "Image", text: "Text", prompt: "Prompt", config: "Generation config", imageGeneration: "Image generation", video: "Video", audio: "Audio", smartCanvas: "Smart Canvas", assets: "Assets" },
        ...
        createMenu: {
            fromNode: "Generate from this node", close: "Close", text: "Generate text", textDescription: "Scripts, ad copy, and brand content", image: "Generate image", video: "Generate video", audio: "Audio reference", config: "Configuration node", configDescription: "Model, size, count, and input order",
        },
        node: {
            node: "Node",
        ...
        promptNode: { pick: "Pick from library", pickerTitle: "Pick a prompt", search: "Search prompts", placeholder: "Type a prompt or pick one from the library", empty: "No prompts", panelHint: "Pick or edit the prompt in the panel below", dragHint: "Drag into the prompt to insert a reference" },
        ...
        switcher: { placeholder: "Switch canvas", nodes: "{{count}} nodes", nodes_one: "{{count}} node", search: "Search canvases", new: "New canvas", empty: "No canvases in this group", group: "Group: {{name}}" }, align: { left: "Align left", centerX: "Align horizontal centres", right: "Align right", top: "Align top", centerY: "Align vertical centres", bottom: "Align bottom", distributeX: "Distribute horizontally", distributeY: "Distribute vertically" }, sidePanel: {
            ...
            group: {
                ...
                delete: "Delete group",
                move: "Move to group",
                defaultName: "Group {{count}}",
                deleteTitle: "Delete group?",
                deleteDescription: "Assets in this group move to Uncategorized. The assets themselves are not deleted.",
            },
        },
        assetPicker: { title: "Select assets", insert: "Insert", search: "Search assets", empty: "No assets" },
        assets: { bind: "Bind folder", rebind: "Change folder", refresh: "Refresh", unbound: "Bind a local folder, then drag its images, videos, audio, or text onto the canvas.", count: "{{count}} files", capped: "Showing the first {{count}} files", empty: "No usable files in this folder", scanFailed: "Failed to read the folder. Try again.", dropHint: "Drag a thumbnail onto the canvas", collectSaving: "Saving to folder…", collectSaved: "Saved to folder", collectFailed: "Save failed", outputBind: "Bind output folder", outputRebind: "Change output folder", outputUnbind: "Unbind output folder", outputUnbound: "No output folder bound", outputUnsupported: "Not supported in this browser", outputWriting: "Writing…", outputFailed: "Write failed" },
        imageTools: { locked: "Lock ratio", free: "Free ratio", lockTitle: "Switch to proportional scaling", freeTitle: "Switch to free resizing", mask: "Local edit", maskTitle: "Paint a mask and edit the selected area", crop: "Crop", cropTitle: "Crop into a new node", split: "Split", splitTitle: "Split the image by rows and columns", resolution: "Resolution", resolutionTitle: "Adjust image resolution", angle: "Multi-angle", angleTitle: "Generate another angle", view: "View image", info: "Image info", showLabels: "Show labels", removeBackground: "Remove background", removeBackgroundTitle: "Remove the image background and create a transparent image", removeBackgroundRunning: "Removing background… (the model is downloaded on first use, about 40MB)", removeBackgroundProgress: "Removing background {{percent}}%", removeBackgroundDownloading: "Downloading background removal model {{percent}}%", removeBackgroundDone: "Background removed", removeBackgroundFailed: "Background removal failed", removeBackgroundResult: "Removed background", resolutionResult: "Resolution result", resolutionAiResult: "AI enhanced result", resolutionAiRunning: "Enhancing resolution…", resolutionAiDone: "Resolution enhanced", resolutionAiFailed: "Enhancement failed", analyze: "Analyze", analyzeTitle: "Analyze colours, EXIF and perceptual hash", ocr: "Extract text", ocrTitle: "Extract the text in the image into a text node", ocrRunning: "Recognising image text…", ocrResult: "OCR result", ocrEmpty: "No text recognised", ocrFailed: "Text recognition failed", segment: "Segment", segmentTitle: "Pick prompt points on the image to build a segmentation mask" },
        ...
        configNode: { title: "Generation config", image: "Image", text: "Text", video: "Video", audio: "Audio", prompt: "Prompt", references: "Reference images", videoReferences: "Reference videos", audioReferences: "Reference audio", items: "{{count}} items", images: "{{count}} images", compose: "Compose prompt", stop: "Stop", generate: "Generate", replaySeed: "Replay seed", matrix: "Matrix", matrixTitle: "Parameter matrix", matrixDescription: "Generate a set of variants at once: sizes, counts and prompts are queued as combinations.", matrixSizes: "Sizes", matrixCounts: "Counts", matrixPrompts: "Prompts", matrixHint: "Separate values with commas or new lines; leave a field empty to skip that dimension.", matrixVariants: "{{count}} variants will be generated", generateVariants: "Generate {{count}} variants", matrixClear: "Clear", matrixSave: "Save", promptSlot: "Drag a prompt node here to bind", promptBound: "Prompt bound", noInputs: "Connect a prompt and references" },
        projectPage: {
        ...
        promptPanel: { video: "Describe the video you want to generate", audio: "Describe the audio you want to generate", image: "Describe the image you want to generate", text: "Describe the text you want to generate", editImage: "Describe how you want to change this image", editText: "Describe how you want to revise this text", expandEditor: "Expand editor", editorTitle: "Edit prompt", stopGeneration: "Stop generation", generate: "Generate", stop: "Stop", variables: "Variables", variablesTitle: "Prompt variables", variablesDescription: "Fill in the variables detected in the prompt; values are replaced at generation time.", variablesEmpty: "No variables found in this prompt", variablesPreview: "Preview", variablesClear: "Clear", variablesSave: "Save", variablesPlaceholder: "Enter a value" },
        ...
        smartCanvas: { preview: "Preview composite", previewTitle: "Smart Canvas preview", download: "Download composite", ratio: "Board ratio", resolution: "Composite resolution", background: "Background", bgTransparent: "Transparent", bgWhite: "White", bgBlack: "Black", bgCustom: "Custom", arrange: "Auto arrange", arrangeDone: "Arranged", saveAsNode: "Save as image node", savedAsNode: "Saved as image node", placedCount: "{{count}} images", placedOnBoard: "On board", empty: "Drag image nodes onto the board to place them", noContent: "No images on the board to compose", composeFailed: "Failed to compose the board", addText: "Add text", defaultText: "Text", deleteText: "Delete text", editTextHint: "Double-click to edit text", layers: "Layers", noLayers: "No images on the board", layoutGrid: "Grid", layoutRow: "Single row", layoutColumn: "Single column", layoutFeature: "Feature image", moveForward: "Move forward", moveBackward: "Move backward", showLayer: "Show layer", hideLayer: "Hide layer", blendMode: "Blend mode", opacity: "Opacity" },
    ...
    config: {
        ...
        workspace: {
            ...
            description: "Bind a local folder and sync canvas projects both ways between the browser and the folder.",
            unsupported: "This browser does not support a local workspace",
            unsupportedDescription: "A local workspace needs the File System Access API. Use the latest desktop Chrome or Edge.",
            bind: "Bind folder",
            rebind: "Change folder",
            unbind: "Unbind",
            folderLabel: "Bound folder",
            unbound: "No folder bound",
            statusLabel: "Sync status",
            syncNow: "Sync now",
            neverSynced: "Not synced yet",
            lastSync: "Last sync: uploaded {{uploaded}}, downloaded {{downloaded}}, conflicts {{conflicts}}",
            nothingToSync: "Nothing to sync",
            syncDone: "Sync complete: uploaded {{uploaded}}, downloaded {{downloaded}}, conflicts {{conflicts}}",
            syncFailed: "Sync failed. Try again.",
            permissionDenied: "No read/write permission for this folder",
            bindFailed: "Failed to bind the folder",
            conflictHint: "Each conflict asks which side to keep; the side you do not keep is saved as a _conflict copy, so both survive in the folder.",
            conflictTitle: "Sync conflict",
            conflictDescription: "“{{fileName}}” changed both locally and in the folder. Choose which side to keep; the other side is saved as a _conflict copy and both are kept.",
            keepLocal: "Keep local",
            keepRemote: "Keep folder",
            conflictResolved: "Conflicts resolved; both sides were kept",
            status: { idle: "Ready", unbound: "Unbound", unsupported: "Not supported", syncing: "Syncing…", synced: "Synced", permissionDenied: "Folder permission required", error: "Sync error" },
        },
        promptSources: {
            add: "Add source",
        ...
        channels: {
            ...
            empty: "Add a provider to configure model endpoints.",
