export default {
    ...
    canvas: {
        ...
        nodeTypes: { image: "Image", text: "Text", prompt: "Prompt", config: "Generation config", imageGeneration: "Image generation", audioGeneration: "Audio generation", musicGeneration: "Music generation", video: "Video", audio: "Audio", smartCanvas: "Smart Canvas", assets: "Assets" },
        ...
        createMenu: {
            fromNode: "Generate from this node", close: "Close", text: "Generate text", textDescription: "Scripts, ad copy, and brand content", image: "Generate image", video: "Generate video", audio: "Audio reference", audioGeneration: "Generate audio", musicGeneration: "Generate music", config: "Configuration node", configDescription: "Model, size, count, and input order",
        },
        node: {
            node: "Node",
