...
export type CanvasNodeType = "image" | "text" | "prompt" | "music-prompt" | "speech-prompt" | "config" | "image-generation" | "speech-generation" | "music-generation" | "video" | "audio" | "smart-canvas" | "assets" | "recording" | "image-modifier";
